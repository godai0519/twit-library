...
#ifndef TWIT_LIB_UTILITY_BASE64_IPP
#define TWIT_LIB_UTILITY_BASE64_IPP
...
OutputIterator base64::encode(InputIterator first, InputIterator last, OutputIterator out) const
{
...
const std::string base64::encode(const std::string& data) const
{
...
const std::string base64::decode(const std::string& data) const
{
    static const std::string table =
        "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
