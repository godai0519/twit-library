#ifndef TWIT_LIB_UTILITY_SHA1_IPP
#define TWIT_LIB_UTILITY_SHA1_IPP
...
inline unsigned int sha1::left_shift(int bits, unsigned int word) const
{
...
std::string sha1::operator() (std::string data, unsigned long long length) const
{
    // 0x80‚ð‹l‚ß‚é
    data.push_back((char)0x80);

    // 64*n + (64-8)bit‚É’B‚·‚é‚æ‚¤‚É0x00‚ð‹l‚ß‚é
